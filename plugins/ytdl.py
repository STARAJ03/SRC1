...
# Author: Shivaay
# GitHub: https://github.com/Shivaay20005/
# Telegram: https://t.me/Shivaay20005
# YouTube: https://youtube.com/@Shivaay20005
# Created: 2025-01-11
...
async def process_audio(client, event, url, cookies_env_var=None):
    ...
    random_filename = f"@Shivaay_pro{event.sender_id}"
    ...
    try:
        ...
        if os.path.exists(download_path):
            def edit_metadata():
                ...
                audio_file.tags["COMM"] = COMM(encoding=3, lang="eng", desc="Comment", text="Processed by Shivaay")
...
async def process_video(client, event, url, cookies_env_var, check_duration_and_size=False):
    ...
    try:
        ...
        title = info_dict.get('title', 'Powered by SHIVAAY')
